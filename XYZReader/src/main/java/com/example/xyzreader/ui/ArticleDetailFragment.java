...
//    private DrawInsetsFrameLayout mDrawInsetsFrameLayout;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (arguments != null) {
//            mItemId = arguments.getParcelable(ArticleDetailFragment.ARG_ITEM_ID);
            mUri = arguments.getParcelable(ArticleDetailFragment.ARG_ITEM_URI);
...
//        mStatusBarColorDrawable = new ColorDrawable(0);
    ...
    private void bindViews() {
        ...
        if (mCursor != null) {
            ...
            String byLine = getString(R.string.detail_by_line, date, author);
...
//                                updateStatusBar();
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        return ArticleLoader.newInstanceForItemUri(getActivity(), mUri);
    }
